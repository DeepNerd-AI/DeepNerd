...
export default function SettingsPage() {
  ...
  async function saveChanges() {
    ...
    // API Keys State
    const [apiKeys, setApiKeys] = useState<{ id: string; name: string; keySnippet: string; date: string }[]>([]);
          ...
          <div className="flex-1 min-w-0 pb-20">
              ...
              <TabsContent value="api-keys" className="m-0 space-y-6">
                ...
                <SettingsCard title="Active Keys">
                  <div className="space-y-4">
                    {apiKeys.length === 0 ? (
                      <div className="flex items-center justify-center p-8 rounded-lg border border-dashed border-white/10 bg-white/5">
                        <div className="text-sm text-zinc-500">No active API keys.</div>
                      </div>
                    ) : (
                      apiKeys.map((key) => (
              ...
              <SettingsCard title="Primary Providers">
                <div className="space-y-6">
                  <div className="grid gap-4">
                    ...
                    <Input type="password" placeholder="sk-ant-..." className="bg-black border-white/10 font-mono text-xs" />
                  </div>
            ...
            <TabsContent value="mcp" className="m-0 space-y-6">
              ...
              <SettingsCard title="Configured Servers">
                <div className="space-y-4">
                  <div className="flex items-center justify-center p-8 rounded-lg border border-dashed border-white/10 bg-white/5">
                    <div className="text-sm text-zinc-500">No MCP servers configured.</div>
                  </div>
