              ...
              <SettingsCard title="Active Keys">
                <div className="space-y-4">
                  <div className="flex items-center justify-between p-4 rounded-lg border border-white/10 bg-white/5">
                    <div>
                      <div className="text-sm font-medium text-white">Production Agent Key</div>
                      <div className="text-xs text-zinc-500 font-mono mt-1">dn_live_xxxxxxxxxxxxx • Created 2d ago</div>
                    </div>
                    <div className="flex gap-2">
                      <Button variant="outline" size="sm" className="border-white/10 bg-transparent hover:bg-white/5">Copy</Button>
                      <Button variant="outline" size="sm" className="border-red-900/30 text-red-400 hover:bg-red-950/30 hover:text-red-300">Revoke</Button>
                    </div>
                  </div>
                  <Button className="w-full bg-white text-black hover:bg-zinc-200">Generate New API Key</Button>
                </div>
              </SettingsCard>
            </TabsContent>
