...
const signals = [
  {
    date: "2025.06.10",
    title: "Agent v2.0 Release",
    note: "Multi-agent coordination with advanced reasoning capabilities and improved autonomy.",
  },
  {
    date: "2025.05.28",
    title: "IDE Performance Update",
    note: "50% faster code analysis and real-time suggestions across all supported languages.",
  },
  {
    date: "2025.05.15",
    title: "API Gateway Launch",
    note: "New REST and GraphQL interfaces for seamless integration into existing development stacks.",
  },
  {
    date: "2025.04.30",
    title: "Model Library Expansion",
    note: "Added specialized models for testing, documentation, and code review automation.",
  },
  {
    date: "2025.04.12",
    title: "Security Framework Release",
    note: "Enterprise-grade security protocols and compliance certifications for production deployments.",
  },
]
...
export function SignalsSection() {
  ...
  return (
    <section id="signals" ref={sectionRef} className="relative py-32 pl-6 md:pl-12">
      <div
        ref={cursorRef}
        className={cn(
