    ...
    <section ref={sectionRef} id="hero" className="relative min-h-screen flex items-center pl-6 md:pl-12 pr-6 md:pr-12">
      ...
      <div ref={contentRef} className="flex-1 w-full z-10 pointer-events-auto">
        ...
        <p className="mt-12 max-w-md font-mono text-sm text-muted-foreground leading-relaxed">
          AI-powered IDEs, autonomous coding agents, and APIs built for modern development workflows. Engineer smarter, ship faster.
        </p>
        ...
        <div className="mt-16 flex items-center gap-8">
          ...
          >
            <ScrambleTextOnHover text="View Products" as="span" duration={0.6} />
