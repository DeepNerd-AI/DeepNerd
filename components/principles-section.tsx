...
export function PrinciplesSection() {
  ...
  const principles = [
    {
      number: "01",
      titleParts: [
        { text: "AI-FIRST", highlight: true },
        { text: " DESIGN", highlight: false },
      ],
      description: "Artificial intelligence integrated at every layer. Built for modern workflows, not legacy constraints.",
      align: "left",
    },
    {
      number: "02",
      ...
      description: "Intuitive APIs and interfaces designed by developers, for developers. Minimal friction, maximum productivity.",
      align: "right",
    },
    {
      number: "03",
      ...
      description: "Self-directed AI that understands context, makes decisions, and executes code independently.",
      align: "left",
    },
    {
      number: "04",
      ...
      description: "Quality you can trust. Rigorous testing, validation, and safety at the core of everything we build.",
      align: "right",
    },
  ]
  ...
  return (
    <section ref={sectionRef} id="principles" className="relative py-32 pl-6 md:pl-12 pr-6 md:pr-12">
      {/* Section header */}
