...
function SplitFlapTextInner({ text, className = "", speed = 50, size = "clamp(4rem, 15vw, 14rem)" }: SplitFlapTextProps) {
...
function SplitFlapChar({ char, index, animationKey, skipEntrance, speed, size, playClick }: SplitFlapCharProps) {
  ...
  const bgColor = isSettled ? "hsl(0, 0%, 0%)" : "rgba(255, 255, 255, 0.14)"
